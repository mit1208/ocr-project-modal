        ...
        >
            ...
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                {state === "thinking" || state === "speaking" ? (
                    ...
                    // Sparkle / Pulse visual
                    <circle cx="12" cy="12" r="6" fill={isActive ? "#0a0a0b" : color} />
                )}
            </svg>
      ...
      `}</style>
                ...
                <div style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 20, width: "100%" }}>
                        <ActivationButton state={state} onClick={handleToggle} />
                        <div style={{ flex: 1 }}>
                            <p style={{
                                fontSize: 14,
                                fontWeight: 600,
                            ...
                            {errorMsg ? (
                                ...
                                <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, color: "#5a5a72", margin: 0 }}>
                                    {state === "listening" ? "Listening..." : "Click to speak"}
                                </p>
                            )}
                        </div>
                    </div>
